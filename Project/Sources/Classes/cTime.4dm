...
Function calcTimeZoneDiff  //  offset between myTime (or value) anmd GMT.
	C_TIME:C306($1;$mycTimeh)
	C_LONGINT:C283($0)
	
	If (Count parameters:C259=1)
		$mycTimeh:=$1
	Else 
		$mycTimeh:=Time:C179(This:C1470.timeValue)
	End if 
	
	$0:=(($mycTimeh)-((Time:C179(Substring:C12(String:C10(Current date:C33;ISO date GMT:K1:10;$mycTimeh);12;19)))))/(60*60)
